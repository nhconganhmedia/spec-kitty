...
_REGISTERED_GATES: tuple[_RegisteredGate, ...] = (
    ...
    # outright, and the two passing candidates that used to live in
    # test_ruff_format_exclude_ratchet.py were retired with the drained
    # formatter-debt exclusion (#4506), so neither is "a remedy this mission
    # did not author" in spirit. test_ruff_format_enforcement.py is
    # untouched by this mission and predates it (#473/#558).
    _RegisteredGate(
