...
def test_bootstrap_threads_owned_mission_into_per_wp_requests(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    owned = OwnedMission(primary=tmp_path, root=tmp_path / "owned", directory=feature_dir, slug="060-test", target="main")
