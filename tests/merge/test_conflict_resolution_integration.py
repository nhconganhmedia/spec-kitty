...
class TestNonConflictingEventsForDifferentWPs:
    ...
    def test_non_conflicting_events_for_different_wps(self):
        ...
        events = [
            _make_event("01CCC00000000000000000001A", "WP01", "planned", "claimed", "2026-01-15T10:00:00+00:00", actor="agent-1"),
            _make_event("01CCC00000000000000000002A", "WP02", "planned", "claimed", "2026-01-15T10:00:00+00:00", actor="agent-2"),
            _make_event("01CCC00000000000000000003A", "WP01", "claimed", "in_progress", "2026-01-15T10:01:00+00:00", actor="agent-1"),
            _make_event("01CCC00000000000000000004A", "WP02", "claimed", "in_progress", "2026-01-15T10:01:00+00:00", actor="agent-2"),
        ]
...
class TestDeduplicationPreservesDeterminism:
    ...
    def test_dedup_with_persistence(self, tmp_path: Path):
        ...
        event1 = _make_event(dup_id, "WP01", "planned", "claimed", "2026-01-15T10:00:00+00:00", mission_slug="099-dedup-test")
        event2 = _make_event(dup_id, "WP01", "planned", "blocked", "2026-01-15T10:00:01+00:00", mission_slug="099-dedup-test")
