...
class FixtureAdapter:
    ...
    def __init__(self, fixture_root: Path | None = None) -> None:
        if fixture_root is None:
            ...
            # src/charter/activation/synthesizer/ -> climb 4 levels -> repo root
            # -> tests/charter/fixtures/synthesizer/
            # (moved one level deeper by mission
            # charter-activation-split-01M16ZSE, MAP-A MOVE -- was 3 levels
            # when this file lived at src/charter/synthesizer/.)
